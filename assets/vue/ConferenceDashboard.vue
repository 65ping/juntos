...
<template>
  <div>
    ...
    <div v-if="conferences.length === 0" class="text-center py-20 text-stone-400 dark:text-stone-500">
    ...
    <div v-else class="space-y-3">
      <div
        ...
        :key="conference.id"
        class="glass-card px-6 py-5 flex items-center justify-between gap-4 group hover:shadow-md transition-shadow"
      >
        <div class="flex items-center gap-4 min-w-0">
          <div class="min-w-0">
            ...
            <div class="flex items-center gap-3 text-xs text-stone-400 dark:text-stone-500">
              <span v-if="conference.location">{{ conference.location }}</span>
              <span v-if="conference.location && conference.starts_at">·</span>
